...
WHERE a_cliente.idcliente NOT IN (SELECT a_cliente.idCliente
                                    ...
                                    WHERE ((A_Reserva.fechaInicio BETWEEN TO_DATE('2022-12-01', 'YYYY-MM-DD') AND TO_DATE('2023-12-29', 'YYYY-MM-DD') ) AND (A_Reserva.fechaFinal BETWEEN TO_DATE('2022-12-01', 'YYYY-MM-DD') AND TO_DATE('2023-12-29', 'YYYY-MM-DD') ))
